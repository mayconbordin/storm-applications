...
public class ReinforcementRedisSpout extends BaseRichSpout {
    private static final long serialVersionUID = 4571831489023437625L;
    private static final Logger LOG = LoggerFactory.getLogger(ReinforcementRedisSpout.class);
    ...
    public ReinforcementRedisSpout(String queue, Fields fields) {
        this.queue = queue;
        this.fields = fields;
    }
