...
import static storm.applications.constants.RealTimeTrafficConstants.*;
 ...
 */
public class RealTimeTrafficTopology extends BasicTopology {
    private static final Logger LOG = LoggerFactory.getLogger(RealTimeTrafficTopology.class);
    
    private int mapMatcherThreads;
    private int speedCalcThreads;

    public RealTimeTrafficTopology(String topologyName, Config config) {
